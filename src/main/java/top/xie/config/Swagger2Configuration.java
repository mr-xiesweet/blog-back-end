...
public class Swagger2Configuration {
    ...
    public Docket portalApi() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .enable(inEnable)
                .select()
                .apis(RequestHandlerSelectors.basePackage("top.xie.controller.portal"))
    ...
    public Docket adminApi() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .enable(inEnable)
                .select()
                .apis(RequestHandlerSelectors.basePackage("top.xie.controller.admin"))
                .paths(PathSelectors.any()) // 可以根据url路径设置哪些请求加入文档，忽略哪些请求
                .build()
                .groupName("管理中心");
    }
    ...
    public Docket UserApi() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .enable(inEnable)
                .select()
                .apis(RequestHandlerSelectors.basePackage("top.xie.controller.user"))
                .paths(PathSelectors.any()) // 可以根据url路径设置哪些请求加入文档，忽略哪些请求
                .build()
                .groupName("用户中心");
    }
